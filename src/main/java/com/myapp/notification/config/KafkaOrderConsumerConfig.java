...
public class KafkaOrderConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Order> orderConsumerFactory(@Value("${spring.kafka.bootstrap-servers}")  String bootstrapServers, JsonDeserializer<Order> orderDeserializer) {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Order> orderListenerContainerFactory(ConsumerFactory<String, Order> consumerFactory) {
